...
# Create movies, actors, stuntman, contact_details objects
...
pain_and_gain.actors = [dwayne_johnson, matt_damon]
...
# Note that we haven't explicitly saved actors. This is not needed because SQLAlchemy,
# by default, uses the save-update cascade strategy in which all objects associated to
# a parent object(via relationship()) gets added to the same Session
